#Import the graph as a long list of individual characters.
data12 <- as.character(unlist(read.fwf("Day 12/input.txt", rep(1, 162))))  
...
#Convert the graph to a list of heights
gr <- unname(setNames(c(1:26, 1, 26), c(letters, "S", "E"))[data12])

#Create list of neighbord to each node.
